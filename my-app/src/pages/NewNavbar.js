      ...
      <div className="collapse navbar-collapse" id="navbarCollapse">
        ...
        <Nav.Link
          ...
          <div className="nav-item dropdown">
            <Link to="/jobs" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Jobs</Link>
          ...
          <div className="nav-item dropdown">
            <Link to="/pages" className="nav-link dropdown-toggle" data-bs-toggle="dropdown"> Login</Link>
            <div className="dropdown-menu rounded-0 m-0">
              <Link to="/login" className="dropdown-item">User Login</Link>
              <Link to="/recruiterlogin" className="dropdown-item">Recruiter Login</Link>
            </div>
          </div>
          <Link to="/contact" className="nav-item nav-link">Contact</Link>
        </div>

        <Link to="/register" className="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">Register<i className="fa fa-arrow-right ms-3"></i></Link>
      </div>
    </nav>
  );
};
